<div class="plan">
    <svg version="1.1" id="sloy_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <path onclick="load_reserv('shooters','2')" class="st0 st03" d="M117.3,151.3c0,12.3-7.7,22.3-17.3,22.3H58.6c-9.5,0-17.3-10-17.3-22.3l0,0c0-12.3,7.7-22.3,17.3-22.3H100
	C109.6,129,117.3,139,117.3,151.3L117.3,151.3z"></path>
        <path onclick="load_reserv('shooters','3')" class="st0 st03" d="M117.3,97.2c0,12.3-7.7,22.3-17.3,22.3H58.6c-9.5,0-17.3-10-17.3-22.3l0,0C41.4,85,49.1,75,58.6,75H100
	C109.6,75,117.3,85,117.3,97.2L117.3,97.2z"></path>
        <path onclick="load_reserv('shooters','4')" class="st0 st03" d="M117.3,48.4c0,12.3-7.7,22.3-17.3,22.3H58.6c-9.5,0-17.3-10-17.3-22.3l0,0c0-12.3,7.7-22.3,17.3-22.3H100
	C109.6,26.2,117.3,36.1,117.3,48.4L117.3,48.4z"></path>
        <ellipse onclick="load_reserv('shooters','5')" class="st0 st03" cx="366" cy="56.3" rx="33.8" ry="32"></ellipse>
        <path onclick="load_reserv('shooters','6')" class="st0 st03" d="M404.6,119.3c0,11.7-6.9,21.1-15.5,21.1h-37.2c-8.6,0-15.5-9.5-15.5-21.1l0,0c0-11.7,6.9-21.1,15.5-21.1h37.2
	C397.7,98.2,404.6,107.7,404.6,119.3L404.6,119.3z"></path>
        <path onclick="load_reserv('shooters','7')" class="st0 st03" d="M404.6,173.6c0,11.7-6.9,21.1-15.5,21.1h-37.2c-8.6,0-15.5-9.5-15.5-21.1l0,0c0-11.7,6.9-21.1,15.5-21.1h37.2
	C397.7,152.5,404.6,161.9,404.6,173.6L404.6,173.6z"></path>
        <path onclick="load_reserv('shooters','8')" class="st0 st03" d="M404.6,231.3c0,11.7-6.9,21.1-15.5,21.1h-37.2c-8.6,0-15.5-9.5-15.5-21.1l0,0c0-11.7,6.9-21.1,15.5-21.1h37.2
	C397.7,210.2,404.6,219.7,404.6,231.3L404.6,231.3z"></path>


        <rect onclick="load_reserv('shooters','9')" x="205.6" y="308.3" class="st0 st03" width="30.1" height="22.3"></rect>
        <rect onclick="load_reserv('shooters','10')" x="205.6" y="340.8" class="st0 st03" width="30.1" height="22.3"></rect>
        <rect onclick="load_reserv('shooters','11')" x="205.6" y="375.8" class="st0 st03" width="30.1" height="22.3"></rect>
        <rect onclick="load_reserv('shooters','12')" x="163" y="375.4" class="st0 st03" width="31.8" height="22.3"></rect>
        <rect onclick="load_reserv('shooters','13')" x="163" y="342.8" class="st0 st03" width="31.8" height="22.3"></rect>
        <rect onclick="load_reserv('shooters','14')" x="163" y="308.8" class="st0 st03" width="31.8" height="22.3"></rect>
