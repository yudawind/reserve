...
//        echo $data . ' -data';
	...
	C109.6,26.2,117.3,36.1,117.3,48.4L117.3,48.4z"></path>
                <ellipse id="rz5" onclick="load_reserv('shooters','5')" class="st0 st03" cx="366" cy="56.3" rx="33.8"
                         ry="32"></ellipse>
	...
	C397.7,210.2,404.6,219.7,404.6,231.3L404.6,231.3z"></path>
                ...
                <rect id="rz9" onclick="load_reserv('shooters','9')" x="205.6" y="308.3" class="st0 st03" width="30.1"
                      height="22.3"></rect>
                <rect id="rz10" onclick="load_reserv('shooters','10')" x="205.6" y="340.8" class="st0 st03" width="30.1"
                      height="22.3"></rect>
                <rect id="rz11" onclick="load_reserv('shooters','11')" x="205.6" y="375.8" class="st0 st03" width="30.1"
                      height="22.3"></rect>
                <rect id="rz12" onclick="load_reserv('shooters','12')" x="163" y="375.4" class="st0 st03" width="31.8"
                      height="22.3"></rect>
                <rect id="rz13" onclick="load_reserv('shooters','13')" x="163" y="342.8" class="st0 st03" width="31.8"
                      height="22.3"></rect>
                <rect id="rz14" onclick="load_reserv('shooters','14')" x="163" y="308.8" class="st0 st03" width="31.8"
                      height="22.3"></rect>
